...
type LanguageDropdownProps = {
  ...
  onChange: (value: 'English' | 'Chinese' | 'Japanese') => void;
  languageIcons: Record<'English' | 'Chinese' | 'Japanese', string>;
};
...
const LanguageDropdown: React.FC<LanguageDropdownProps> = ({
  ...
  const languages: ('English' | 'Chinese' | 'Japanese')[] = ['English', 'Chinese', 'Japanese'];
